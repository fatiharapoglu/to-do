...
class Storage {
    ...
    static getFromStorage() {
        ...
        if (retrievedProjects === null) {
            ...
            newWrapper.setProjectList(newWrapper.getProjectList().map(project => Object.assign(new Project(), project)));
            newWrapper.getProjectList().forEach(project => project.setTaskList(project.getTaskList().map(task => Object.assign(new Task(), task))));
